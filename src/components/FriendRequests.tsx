        ...
        friendRequests.map((friendRequest: IncomingFriendRequest) => (
          <div key={friendRequest.senderId} className="flex gap-4 items-center">
            ...
            <button
              ...
              className="w-8 bg-green-400 hover:bg-green-500 grid place-items-center rounded-full transition hover:shadow-md"
            >
              <Check className="font-semibold text-white w-3/4 h-3/4" />
            </button>
            <button
              onClick={() => rejectFriend(friendRequest.senderId)}
              aria-label="reject friend"
              className="w-8 bg-red-400 hover:bg-red-500 grid place-items-center rounded-full transition hover:shadow-md"
            >
