    ...
    <ul role="list" className="max-h-[25rem] overflow-y-auto -mx-2 space-y-1">
      {activeChats.sort().map((friend) => {
        ...
        return (
          <li key={friend.id}>
            <a
              className="text-gray-700 hover:text-blue-40 duration-200 hover:bg-gray-50 group flex items-center gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold"
