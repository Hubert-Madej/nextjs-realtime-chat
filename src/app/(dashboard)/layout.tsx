    ...
    <div className="w-full flex h-screen">
      ...
      <div className="hidden md:flex h-full w-full max-w-xs grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6">
        <Link href="/dashboard" className="flex h-16 shrink-0 items-center">
          <h1 className="font-semibold text-3xl leading-6 tracking-wider text-gray-400">
            Chat<span className="ml-2 font-medium text-indigo-600">App</span>
          </h1>
        </Link>
        {friends.length > 0 && (
            ...
            <li className="-mx-6 mt-auto flex items-center border-t border-gray-200">
              <div className="flex flex-1 items-center gap-x-4 px-6 py-3 text-sm font-semibold leading-6 text-gray-900">
                ...
                <div className="flex flex-col">
                  ...
                  <span
                    className="text-xs text-zinc-400 w-36 truncate"
                    aria-hidden="true"
                  >
                    {session.user.email}
                  </span>
